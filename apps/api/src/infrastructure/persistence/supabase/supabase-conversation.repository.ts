...
import { ConversationType } from "../../../domain/conversation/value-objects/conversation-type.value-object";
...
import { ConversationDetailsDto, MemberDto } from "../../../shared/dto/conversation/conversation-details.dto";
import { ConversationListElementDto } from "../../../shared/dto";
...
export class SupabaseConversationRepository implements ConversationRepository {
  ...
  private constructMessage(lastMessageData: any, sender: User, conversationId: string): Message {
    return new Message(
      ...
      MessageStatusValueObject.create(lastMessageData.status || "SENT"),
