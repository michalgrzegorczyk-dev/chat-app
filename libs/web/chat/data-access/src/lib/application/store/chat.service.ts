...
export class ChatStoreService {
  ...
  private readonly rxState = rxState<ChatState>(({ set, connect }) => {
    ...
    connect(
      ...
      this.setConversationListLoading$,
    ...
    connect(this.selectConversation$, (state, conversation) => {
      ...
      const activeConversation =
        updatedConversations.find((conv) => conv.active) || null;
  ...
  readonly conversationListLoading = this.rxState.signal(
    'conversationListLoading'
  );
  readonly selectedConversation = this.rxState.signal('selectedConversation');
  readonly selectedConversationLoading = this.rxState.signal(
