...
const DEFAULT_TEXT_CONFIG: Pick<ToggleTextConfig, 'weight' | 'size' | 'color' | 'shade' | 'shadeDark'> = {
  size: 'sm',
  weight: 'medium',
  color: 'gray',
  shade: '900',
...
@Component({
  ...
  template: `
    <label class="relative inline-flex cursor-pointer items-center">
      <input class="peer sr-only" id="theme-toggle" type="checkbox" [checked]="value()" />
      <div (click)="changeState()"
      class="peer-focus:ring-primary-300 dark:peer-focus:ring-primary-800
